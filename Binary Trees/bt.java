...
public class bt {
    ...
    static class BinaryTree {
        ...
        public static Info diameter2(Node root) {           //TC=O(n)
            ...
            int dia=Math.max(lInfo.ht+rInfo.ht+1,Math.max(lInfo.dia,rInfo.dia));
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Sum of Nodes of Tree:"+tree.sumOfNodes(root));
        System.out.println("Diameter of Tree:"+tree.diameter(root));
        System.out.println("Diameter of Tree(Approach 2):"+tree.diameter2(root).dia);
    }  
}
